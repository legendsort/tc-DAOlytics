...
CHANNELS = ["acaciatest", "askverida", "chinese", "devchat",  "devprotocol", \
	...
	"quest", "research", "spanish", "turkish", "ucranian"]
...
def main(args):
	...
	file_identifier = "community_activity_analysis_{}_{}dayHist_noRus.json".format(COMMUNITY_ID, DAY_HIST)
	...
	range_file_name = "{}/all_range_".format(COMMUNITY_ID) + file_identifier
	hourly_file_name = "{}/hourly_".format(COMMUNITY_ID) + file_identifier
	channel_file_name = "{}/channel_".format(COMMUNITY_ID) + file_identifier
	...
	if SHOW[2]:
		...
		hm_ax = sns.heatmap(mess_hourly, cmap="Greens", linewidth=1, annot=True, \
